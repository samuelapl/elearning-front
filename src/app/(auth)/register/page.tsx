...
import { ArrowRight, Building2, GraduationCap, Lock, Mail, Phone, UserRound } from "lucide-react";
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.07] p-6 shadow-2xl shadow-indigo-950/40 backdrop-blur-xl sm:p-8">
          <div className="text-center">
            ...
            <p className="mt-1.5 text-sm text-slate-400">
              Create a learner account. An administrator must approve it before you can sign in.
            </p>
          </div>

          {submitted ? (
            <div className="mt-7 rounded-xl border border-emerald-400/20 bg-emerald-500/10 px-4 py-4 text-sm leading-relaxed text-emerald-100">
              Registration submitted successfully. Your account is pending administrator
              approval. You will be able to log in after your account has been approved.
              <Link
                href="/login"
                className="mt-4 flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 to-violet-500 px-5 py-3 text-sm font-semibold text-white"
              >
                Return to sign in
